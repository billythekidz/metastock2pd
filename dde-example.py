...
if __name__ == "__main__":
    ...
    class MyRequestTopic(object.Object):
        def __init__(self, topicName):
            self.topic = dde.CreateTopic(topicName)
            self.topic.AddItem(dde.CreateStringItem(""))
            object.Object.__init__(self, self.topic)
            self.items = {}
    ...
    nifty50Topic = MyRequestTopic("MSFT")
    server.AddTopic(nifty50Topic)
    server.Create('TestServer')

    while 1:
        nifty50Topic.setData('Open', '450.45')
        nifty50Topic.setData('High', '450.45')
        nifty50Topic.setData('Last', '450.45')
        nifty50Topic.setData('Low', '450.45')
        nifty50Topic.setData('Time', '13:59:00')
        nifty50Topic.setData('Date', '10/24/2020')
